...
namespace HelloCrawler
{
	public class Game
	{
		...
		public void display(Movement playerMovement, Player currentPlayer) //Te muestra la posicion en la que estas actualmente.
		{
			
			if (currentPlayer.hp != 0)
			{
				switch (playerMovement.position)
				{
					case 5:
		...
		public void display2(Movement playerMovement, Player currentPlayer) //Este es el set de habitaciones en caso de que ya haya estado ahi. 
		{
			switch (playerMovement.position)
			{
				case 5:
